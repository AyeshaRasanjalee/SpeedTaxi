...
<body class="body">
	...
	%>
	<div class="bg-img1">
		<form action="delete" class="container" method="post">
			<center>
				<h1>************* Delete booking data *****************</h1>
			</center>
			...
			<label><b>Booking id </b></label> <input type="text"
				...
				readonly> <label><b>Pickup location</b></label> <input
				type="text" value="<%= ploc%>" name="plocation" id="plocation"
				readonly> <label><b>Drop location</b></label> <input
				type="text" value="<%= dloc%>" name="dlocation" readonly> <label><b>Email
			</b></label> <input type="text" value="<%= mail%>" name="email" readonly>

			<label><b>Pickup date</b></label>
			<h5>Use like year-month-day Ex :2020-10-10</h5>
			<input type="date" value="<%= date%>" name="date" readonly><br />

			<label><b>Time </b></label>
			<h4>Use 24hr time hour:minute:seconds Ex :00:00:00</h4>
			<input type="time" value="<%= time%>" name="time" readonly> <img
				src="vehi.jpg" style="height: 200px; width: 900px"><br /> <label><b>
					vehicle type(Threeweel , car, van) :</b></label> <input type="text"
				value="<%= vehi%>" name="vehi" readonly> </br>
			</br>
			<button type="submit" class="btn">Delete booking data</button>
		</form>
